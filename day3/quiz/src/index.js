...
demo.spreadOperator = function() {
    ...
    console.log(getMinMax("min", 20, 30));
}
...
demo.templateLiterals = function() {
    ...
    function getDate() {
        ...
        return today.getFullYear() +"년"+ (today.getMonth() + 1) +"월"+ today.getDay() +"일";
    }
...
// *** fetch API
demo.fetch = function() {
    // 다음 API를 fetch를 상요해 호출하고, 데이터를 출력하세요
